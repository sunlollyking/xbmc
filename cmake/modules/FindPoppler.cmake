...
if(NOT TARGET ${APP_NAME_LC}::${CMAKE_FIND_PACKAGE_NAME})
  ...
  macro(buildmacroPoppler)
    ...
    # The imported target is checked at configure time, before the dependency
    # has been built and its headers installed
    ...
    # Named rather than searched for: it is built alongside and does not exist
    # yet when this runs.
    list(APPEND ${${CMAKE_FIND_PACKAGE_NAME}_MODULE}_LINK_LIBRARIES
         ${DEP_LOCATION}/lib/${CMAKE_STATIC_LIBRARY_PREFIX}poppler${CMAKE_STATIC_LIBRARY_SUFFIX})
