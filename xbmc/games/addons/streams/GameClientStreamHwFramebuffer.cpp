                                                ...
                                                const game_stream_properties& properties)
{
  ...
  // After the handle is in place rather than before it: clients ask for their
  // framebuffer from inside context_reset, and a request that arrives while
  // the stream is still opening has nothing to answer it
