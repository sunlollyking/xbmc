...
size_t CGameClient::GetSerializeSize() const
{
  ...
  // game's boot cannot answer before it has run. Waiting for a frame costs
  // nothing, because savestates and rewind cannot happen before one either.
