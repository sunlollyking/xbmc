...
{
  m_manager.GetInputManager().UnregisterCecInputHandler(this);
...
bool CPeripheralCecAdapter::InitialiseFeature(const PeripheralFeature feature)
{
  if (feature == FEATURE_CEC && !m_bStarted && GetSettingBool("enabled"))
  {
    ...
    m_manager.GetInputManager().RegisterCecInputHandler(this);
  }

  return CPeripheral::InitialiseFeature(feature);
}

bool CPeripheralCecAdapter::GetCecKey(CKey& key)
{
