...
constexpr uint32_t RETROPLAYER_ACHIEVEMENTS_HARDCORE = 1723;
constexpr uint32_t RETROPLAYER_HAS_CHEATS = 1724;
constexpr uint32_t RETROPLAYER_HAS_LEADERBOARDS = 1725;
...
constexpr uint32_t LISTITEM_PLATFORM                 = LISTITEM_START + 233;
constexpr uint32_t LISTITEM_DEVELOPER                = LISTITEM_START + 234;
constexpr uint32_t LISTITEM_PUBLISHER                = LISTITEM_START + 235;
constexpr uint32_t LISTITEM_PLAYERS                  = LISTITEM_START + 236;
constexpr uint32_t LISTITEM_REGION                   = LISTITEM_START + 237;
constexpr uint32_t LISTITEM_RELEASE_COUNT            = LISTITEM_START + 238;
constexpr uint32_t LISTITEM_ACHIEVEMENTS_TOTAL       = LISTITEM_START + 239;
constexpr uint32_t LISTITEM_ACHIEVEMENTS_EARNED      = LISTITEM_START + 240;
constexpr uint32_t LISTITEM_GAME_CATEGORY            = LISTITEM_START + 241;
constexpr uint32_t LISTITEM_GAME_CLIENT              = LISTITEM_START + 242;
constexpr uint32_t LISTITEM_ACHIEVEMENTS_PERCENT     = LISTITEM_START + 243;
constexpr uint32_t LISTITEM_ACHIEVEMENTS_GAME_ID     = LISTITEM_START + 245;
constexpr uint32_t LISTITEM_ACHIEVEMENTS_PROGRESS    = LISTITEM_START + 244;
