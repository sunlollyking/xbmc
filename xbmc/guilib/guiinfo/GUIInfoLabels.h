...
constexpr uint32_t RETROPLAYER_LEADERBOARD_TRACKER  = 1726;
...
constexpr uint32_t RETROPLAYER_HAS_CHEATS            = 1718;
constexpr uint32_t RETROPLAYER_HAS_LEADERBOARDS       = 1724;
...
constexpr uint32_t LISTITEM_ACHIEVEMENTS_PERCENT     = LISTITEM_START + 242;
constexpr uint32_t LISTITEM_ACHIEVEMENTS_PROGRESS    = LISTITEM_START + 243;
