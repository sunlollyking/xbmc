...
{
public:
  virtual ~IRetroEngineStream() = default;
   ...
   * \param nominalDisplayAspectRatio The expected display aspect ratio (DAR), or 0.0f for square pixels
   *
  ...
  virtual bool OpenStream(RETRO::IRetroPlayerStream* stream,
                          ...
                          float nominalDisplayAspectRatio) = 0;
   ...
   * \param displayAspectRatio The aspect ratio to display the frame at, or 0.0f for square pixels
