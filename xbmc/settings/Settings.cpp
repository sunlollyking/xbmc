...
void CSettings::InitializeISettingCallbacks()
{
  ...
  GetSettingsManager()->RegisterCallback(
      ...
      {CSettings::SETTING_MUSICLIBRARY_CLEANUP, CSettings::SETTING_MUSICLIBRARY_EXPORT,
       ...
       CSettings::SETTING_VIDEOLIBRARY_SHOWUNWATCHEDPLOTS, CSettings::SETTING_GAMELIBRARY_CLEANUP,
       CSettings::SETTING_GAMELIBRARY_REFRESHPROGRESS, CSettings::SETTING_GAMELIBRARY_EXPORT,
       CSettings::SETTING_GAMELIBRARY_IMPORT,
